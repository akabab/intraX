...
app.controller('SidebarCtrl', ['$scope', '$http', function ($scope, $http) {
  $scope.links = [
    {"name": 'Inbox',       "deploy":true,  "unseen": 5, "sublinks": [{"name": 'Messages', "unseen": 3}, {"name": 'Tickets', "unseen": 0}]},
    {"name": 'Fôrum',       "deploy":true,  "unseen": 2, "sublinks": []},
  ...
  function formatLink(string) {
    string = removeDiacritics(string).replace((/(['\s]+)/g), '-');
